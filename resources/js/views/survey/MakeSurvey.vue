    ...
    <case-card>
      ...
      >
        ...
        <vs-col vs-w="3" vs-type="flex" vs-justify="center" vs-align="center">
          <vs-dropdown>
            <vs-button type="filled" class="flex-1 btnx hover:cursor-pointer"
              >문항 추가</vs-button
            >
            <vs-dropdown-menu>
              <vs-dropdown-group
                vs-label="주관형"
                class="mt-0 outline-none border-0"
              >
      ...
      <vs-row class="mt-3">
        <vs-col>
          ...
          <vs-input-number class="mb-2 w-24" v-model="credit" :step="50" />
        </vs-col>
      </vs-row>
      <vs-row vs-w="12" vs-type="flex" class="mb-4">
        ...
        >
          <vs-button
            type="filled"
            color="success"
            class="btnx hover:cursor-pointer"
            >설문 등록</vs-button
          >
        </vs-col>
      </vs-row>
